...
public class Client  implements ActionListener {
    ...
    Client(){
        ...
        ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("photo/arr.png"));
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("photo/2.png"));
        ...
        ImageIcon i7=new ImageIcon(ClassLoader.getSystemResource("photo/video.png"));
        ...
        ImageIcon i10=new ImageIcon(ClassLoader.getSystemResource("photo/phone.png"));
        ...
        ImageIcon i13=new ImageIcon(ClassLoader.getSystemResource("photo/3dot.png"));
        Image i14=i13.getImage().getScaledInstance(10,27,Image.SCALE_DEFAULT);
        ImageIcon i15=new ImageIcon(i14);
        JLabel dot=new JLabel(i15);
        dot.setBounds(400,20,25,25);
        p1.add(dot);

        JLabel name=new JLabel("Vivek");
        name.setBounds(90,20,100,23);
        name.setForeground(Color.white);
        name.setFont(new Font("san serif",Font.BOLD,20));
        p1.add(name);

        JLabel active =new JLabel("Online");
        active.setBounds(95,45,50,10);
    ...
    public static JPanel formatLabel(String out){
        ...
        output.setBackground(new Color(7,134,84));
